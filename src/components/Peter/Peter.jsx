...
import peterYear1_1 from "./peterYear1_1.js";
import peterYear1_2 from "./peterYear1_2.js";
import peterYear2_1 from "./peterYear2_1.js";
import peterYear2_2 from "./peterYear2_2.js";
import { Link } from "react-router-dom";

const Peter = (props) => {
  return (
    <>
      {peterYear1_1.map((student) => {
        const {
          id,
          name,
          lastName,
