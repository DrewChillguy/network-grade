...
import tickYear1_1 from "./tickYear1_1.js";
import tickYear1_2 from "./tickYear1_2.js";
import tickYear2_1 from "./tickYear2_1.js";
import tickYear2_2 from "./tickYear2_2.js";
import { Link } from "react-router-dom";

const Tick = (props) => {
  return (
    <>
      {tickYear1_1.map((student) => {
        const {
          id,
          name,
          lastName,
