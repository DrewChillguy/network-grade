...
import khumphouYear1_1 from "./khumphouYear1_1.js";
import khumphouYear1_2 from "./khumphouYear1_2.js";
import khumphouYear2_1 from "./khumphouYear2_1.js";
import khumphouYear2_2 from "./khumphouYear2_2.js";
import { Link } from "react-router-dom";

const Khumphou = (props) => {
  return (
    <>
      {khumphouYear1_1.map((student) => {
        const {
          id,
          name,
          lastName,
