...
import ningYear1_1 from "./ningYear1_1.js";
import ningYear1_2 from "./ningYear1_2.js";
import ningYear2_1 from "./ningYear2_1.js";
import ningYear2_2 from "./ningYear2_2.js";
import { Link } from "react-router-dom";

const Ning = (props) => {
  return (
    <>
      {ningYear1_1.map((student) => {
        const {
          id,
          name,
          lastName,
